...
/* 计算32位的md5,  摘自  https://github.com/ulwanski/md5
* 另外一个： https://github.com/JieweiWei/md5 代码看起来也很清爽
*/
...
#define MD5_NAMESPACE_BEGIN    namespace md5 {  
...
static char hb2hex(unsigned char hb) {
    hb = hb & 0xF;
    return hb < 10 ? '0' + hb : hb - 10 + 'a'; //这里'a'->'A'即可返回大写字符串
}
